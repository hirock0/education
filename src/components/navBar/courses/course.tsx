...
export default function CoresePage(){
    return(
        <div id='Courses' className={Style.main}>
            <ul id={Style.CoursesUL} className=' h-full gap-5 flex flex-col justify-around p-5 backdrop:filter backdrop-blur-3xl bg-zinc-860/100 opacity-95 border'>
