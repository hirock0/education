...
export default function AboutUs(){
    return(
        <div id='AboutUs' className={Style.main}>
            <ul id={Style.aboutusUL} className=' h-full gap-5 flex flex-col justify-around p-5 backdrop:filter backdrop-blur-3xl bg-zinc-860/100 opacity-95 border'>
