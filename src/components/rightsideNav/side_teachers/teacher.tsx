...
export default function Teachers_side(){
    return(
        <div id='Teachers_side' className={Style.main}>
            <ul id={Style.TeachersUL} className=' h-full gap-5 flex flex-col justify-around p-5 backdrop:filter backdrop-blur-3xl bg-zinc-900/30 opacity-100'>
                ...
                <Link href={`/informations/teachers/commerce_teachers`}><li><span><Image src={`/all_svg/presentation-fill.svg`} alt='Commerce' width={15} height={15}/></span><span id={Style.CommerceText}>Commerce Teachers</span></li></Link>
