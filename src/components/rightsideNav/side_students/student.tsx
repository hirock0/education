...
export default function Students_side(){
    return(
        <div id='Students_side' className={Style.main}>
            <ul id={Style.StudentsUL} className=' h-full gap-5 flex flex-col justify-around p-5 backdrop:filter backdrop-blur-3xl bg-zinc-900/30 opacity-100'>
