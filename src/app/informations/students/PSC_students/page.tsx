import Style from './pscstudets.module.css'
export default function PscStudentsPage(){
    return(
        <main id={Style.main} className=' pr-5 pl-5'>
            <h1 className=' underline underline-offset-4 text-center mt-5 lg:text-xl md:text-xl sm:text-xl'>PSC Students</h1>
