import Style from './hscStudents.module.css'
export default function HscStudentsPage(){
    return(
        <main id={Style.main} className=' pr-5 pl-5'>
            <h1 className=' underline underline-offset-4 text-center mt-5 lg:text-xl md:text-xl sm:text-xl'>HSC Students</h1>
