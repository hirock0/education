import Style from './mastudents.module.css'
export default function MaStdentsPage(){
    return(
        <main id={Style.main} className=' pr-5 pl-5'>
            <h1 className=' underline underline-offset-4 text-center mt-5 lg:text-xl md:text-xl sm:text-xl'>MA Students</h1>
